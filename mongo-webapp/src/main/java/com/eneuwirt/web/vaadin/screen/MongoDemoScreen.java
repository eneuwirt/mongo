package com.eneuwirt.web.vaadin.screen;

import com.eneuwirt.web.vaadin.application.MyApplication;
...
public class MongoDemoScreen extends Panel
{
	...
	public MongoDemoScreen(MyApplication app)
	{
		this.app = app;
	...
	private static final class ListenerMongoFill implements ClickListener
	{
		...
		public ListenerMongoFill(MyApplication app, MongoDemoScreen screen)
		{
			this.app = app;
			this.screen = screen;
		}
	...
	private static final class ListenerMongoClear implements ClickListener
	{
		...
		public ListenerMongoClear(MyApplication app, MongoDemoScreen screen)
		{
			this.app = app;
			this.screen = screen;
		}
